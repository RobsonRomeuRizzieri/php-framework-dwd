...
//Executa o SQL e não retorna uma matriz com o SQL
$obj->inserir("",false);
...
//O método Executar SQL tem uma propriedade que quando é executado um SQL de consulta.
//for necessário mostrar retornar uma matriz com os valores da consulta deve ser definida para true
...
//Gera novo ID para o registro
$obj_inc = new db_auto_incremento(0,0,"DWD_OBJETO_STATUS","ID","MySQL","localhost","dwd","root","","",false);
//insere o segundo registro pode ser definido o SQL diretamento no método, Não retorna matriz com SQL
