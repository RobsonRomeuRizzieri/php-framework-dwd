<?php
class agenda_atividade extends entidade{

	public function __construct($str_entidade="agenda_atividade",$str_banco_tipo="",$str_servidor="",$str_banco="",$str_usuario="",$str_senha="",$str_porta="",$bol_sql_exibir=false,$bol_sql_maiusculo=true,$bol_sql_padrao=true,$bol_aspas_crase=false){
    parent::__construct($str_entidade,$str_banco_tipo,$str_servidor,$str_banco,$str_usuario,$str_senha,$str_porta,$bol_sql_exibir,$bol_sql_maiusculo,$bol_sql_padrao,$bol_aspas_crase);
		$this->str_arquivo_filtro = "agenda/agenda_atividade_consulta_item.php";
		$this->str_arquivo_filtro_resultado = "agenda/agenda_atividade_consulta_filtro.php";
		$this->str_cadastro_arquivo = "agenda/agenda_atividade_cadastro.php";
		$this->str_cadastro_local = "content";
		$this->str_consulta_arquivo = "agenda/agenda_atividade_consulta.php";
		$this->str_consulta_arquivo_executar = "agenda/agenda_atividade_consulta_executar.php";
		$this->str_consulta_local = "content";
		$this->str_resultado_arquivo = "agenda/agenda_atividade_cadastro_executar.php";
		$this->str_arquivo_relatorio = "agenda/agenda_atividade_relatorio.php";
		$this->str_arquivo_relatorio_executar = "agenda/agenda_atividade_relatorio_executar.php";
