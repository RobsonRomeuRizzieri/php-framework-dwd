...
class empresa extends entidade{
	...
	public function __construct($str_entidade="sys_empresa",$str_banco_tipo="",$str_servidor="",$str_banco="",$str_usuario="",$str_senha="",$str_porta="",$bol_sql_exibir=false,$bol_sql_maiusculo=true,$bol_sql_padrao=true,$bol_aspas_crase=false){
    parent::__construct($str_entidade,$str_banco_tipo,$str_servidor,$str_banco,$str_usuario,$str_senha,$str_porta,$bol_sql_exibir,$bol_sql_maiusculo,$bol_sql_padrao,$bol_aspas_crase);
		$this->str_arquivo_filtro = "empresa/empresa_consulta_item.php";
		$this->str_arquivo_filtro_resultado = "empresa/empresa_consulta_filtro.php";
		$this->str_cadastro_arquivo = "empresa/empresa_cadastro.php";
		$this->str_cadastro_local = "content";
		$this->str_consulta_arquivo = "empresa/empresa_consulta.php";
		$this->str_consulta_arquivo_executar = "empresa/empresa_consulta_executar.php";
		$this->str_consulta_local = "content";
		$this->str_resultado_arquivo = "empresa/empresa_cadastro_executar.php";

    $this->str_con_descricao = "Manutenзгo da empresa";
    $this->str_nome = "Empresa";
    $this->arr_detalhe[0] = new empresa_filial();
